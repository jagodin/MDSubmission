...
AddCircAtomicArray(6, 2e-9, 2e-9, 0, 0, 0, T, 1);
AddEllipAtomicArray(4, -3e-9, -3e-9, 0, 0, 0, T, 1);
AddRectAtomicArray(5, 5, -3e-9, 3e-9, 0, 0, 0, T, 0);
...
AddParticleStream(5, -10, 0, 0, 0, 5*Ep * C.q_0, 5);
